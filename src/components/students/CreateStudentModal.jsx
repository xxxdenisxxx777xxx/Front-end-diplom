...
function CreateStudentModal({ isOpen, onClose }) {
    ...
    const handleSubmit = async () => {
        try {
            const { firstName, lastName, departmentEmail, phoneNumber, email } = studentData;
            const departmentId = '3fa85f64-5717-4562-b3fc-2c963f66afa1';  // Если departmentId всегда одинаковый, используйте его. Иначе, получите его из других данных
            ...
            {isOpen && (
                <div className="fixed top-0 left-0 w-full h-full flex justify-center items-center bg-black bg-opacity-50">
                    <div className="bg-white p-8 rounded-md">
                        <h2 className="text-2xl font-bold mb-4">Створити нового студента</h2>
                        <div className='gap-10'>
                            ...
                            <select
                                ...
                                value={studentData.departmentEmail}
                                onChange={handleChange}
                            >
                                <option value="">Оберіть групу</option>
                                <option value="KH20-1">КН20-1</option>
                                <option value="КН20-2">КН20-2</option>
                                <option value="КН21-1">КН21-1</option>
                                <option value="КН21-2">КН21-2</option>
                            </select>
                        </div>
