...
const StudentsList = () => {
    ...
    const [isModalOpenInfoStudent, setIsModalOpenInfoStudent] = useState(false);
    ...
    const openModalInfoStudent = (id) => {
        const selectedStudent = filteredData.find(student => student.id === id);
        setSelectedStudentData(selectedStudent);
        setIsModalOpenInfoStudent(true);
    };


    const closeModalInfoStudent = () => {
        setIsModalOpenInfoStudent(false);
    };
        ...
        <div className="flex flex-col gap-4">
            ...
            <div className="w-full min-w-[30rem] border p-4 bg-white rounded-xl shadow-[0_4px_10px_rgba(0,0,0,0.03)]">
                <table className="w-full">
                    <thead>
                        <tr>
                            <th className="px-3 text-start text-xs font-light uppercase">Прізвище та Им'я</th>
            ...
            <CreateStudentModal isOpen={isModalOpen} onClose={closeModal} onSubmit={handleCreateStudent} />
            <InfoStudentModal isOpen={isModalOpenInfoStudent} onClose={closeModalInfoStudent} studentData={selectedStudentData} />
        </div>
