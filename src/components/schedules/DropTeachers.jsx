...
export default function DropTeachers({ onChange }) {
            ...
            {({ open }) => (
                <>
                    <div className='w-full'>
                        <Listbox.Label className="block border-none w-full text-md font-medium leading-6 text-gray-900">Оберіть вчителя</Listbox.Label>
                        <div className="relative mt-2">
                            <Listbox.Button className="relative w-full cursor-default rounded-md bg-white py-2.5 pl-3 pr-10 text-left text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-500 sm:text-sm sm:leading-6">
                                <span className="flex items-center">
                                    <span className="ml-3 block truncate">{selected ? selected.firstName + " " + selected.lastName : "Loading..."}</span>
                                </span>
                                            ...
                                            {({ selected, active }) => (
                                                <>
                                                    <div className="flex items-center">
                                                        ...
                                                        >
                                                            {discipline.firstName + " " + discipline.lastName}
                                                        </span>
                                                    </div>
