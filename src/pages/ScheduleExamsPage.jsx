...
const ScheduleExamsPage = () => {
    const initialSchedule = [
        {
            date: "Пн",
            classes: [
                { period: "1", week: "1", groups: ["", "", "", ""] },
                { period: "2", week: "1", groups: ["С#", "", "", ""] },
                { period: "3", week: "1", groups: ["", "", "", ""] },
                { period: "4", week: "1", groups: ["КМР Основи технології та дизайну", "КМР Основи технології та дизайну", "", ""] },
            ],
        },
        {
            date: "Вт",
            classes: [
                { period: "1", week: "1", groups: ["", "", "", ""] },
                { period: "2", week: "1", groups: ["", "", "", ""] },
                { period: "3", week: "1", groups: ["", "JAVA", "", ""] },
        ...
        },
        {
            ...
            classes: [
                { period: "1", week: "1", groups: ["", "", "", ""] },
                { period: "2", week: "1", groups: ["C#", "", "C#", "C#"] },
                { period: "3", week: "1", groups: ["Vite+React", "", "", "Vite+React"] },
                { period: "4", week: "1", groups: ["", "", "", ""] },
            ],
        },
        {
            date: "Чт",
            classes: [
                { period: "1", week: "1", groups: ["", "КМР FIGMA & Photoshop", "", ""] },
                { period: "2", week: "1", groups: ["", "", "", ""] },
                { period: "3", week: "1", groups: ["", "", "КМР Фотографія та дизайн", ""] },
                { period: "4", week: "1", groups: ["", "", "", ""] },
            ],
        }, {
            date: "Пт",
            classes: [
                { period: "1", week: "1", groups: ["Психологія", "", "", "Економіка та бізнес комунікації"] },
                { period: "2", week: "1", groups: ["Технологія", "", "", ""] },
                { period: "3", week: "1", groups: ["", "", "", "Класифікация компьютерних систем"] },
                { period: "4", week: "1", groups: ["", "", "", ""] },
            ],
        },
        {
